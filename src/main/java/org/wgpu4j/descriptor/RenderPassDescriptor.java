 ...
 */
public class RenderPassDescriptor implements Marshalable {
    ...
    public MemorySegment marshal(Arena arena) {
        ...
        if (!colorAttachments.isEmpty()) {
            ...
            for (int i = 0; i < colorAttachments.size(); i++) {
                MemorySegment attachmentStruct = colorAttachments.get(i).marshal(arena);
        ...
        if (depthStencilAttachment != null) {
            MemorySegment depthStencilStruct = depthStencilAttachment.marshal(arena);
