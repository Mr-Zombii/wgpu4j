 ...
 */
public class BlendState implements Marshalable {
    ...
    public MemorySegment marshal(Arena arena) {
        ...
        MemorySegment.copy(color.marshal(arena), 0L, colorComponent, 0L, WGPUBlendComponent.sizeof());

        MemorySegment alphaComponent = WGPUBlendState.alpha(struct);
        MemorySegment.copy(alpha.marshal(arena), 0L, alphaComponent, 0L, WGPUBlendComponent.sizeof());
     ...
     */
    public static class BlendComponent implements Marshalable {
