...
import org.wgpu4j.descriptor.DeviceDescriptor;
import org.wgpu4j.descriptor.DeviceRequestOptions;
...
public class Adapter extends WgpuResource {
     ...
     */
    public org.wgpu4j.descriptor.Limits getLimits() {
        checkNotClosed();
        ...
        return org.wgpu4j.descriptor.Limits.fromNative(limitsStruct);
    }
    ...
    public CompletableFuture<Device> requestDevice(DeviceDescriptor deviceDescriptor) {
        ...
        try {
            ...
            MemorySegment deviceDescriptorStruct = deviceDescriptor.marshal(callbackArena);
    ...
    public DeviceDescriptor createDeviceDescriptorWithAdapterLimits(String label) {
        org.wgpu4j.descriptor.Limits adapterLimits = getLimits();
